...
def test_operation_id_with_multiple_methods():
    """Ensure a unique operation id is generated for each method"""
    app = FastAPI()
    router = APIRouter()
    ...
    router.add_api_route("/test", root, methods={"GET", "POST"})
    app.include_router(router)
